...
but due to a lack of time, its incomplete state, and some major errors yet to be fixed in the repository, I've decided to make this repository.  
Eventually I plan to move everything GC/Wii kernel related there, but for the time being here is the 3.12 branch...
...
This is the 3.12.y GC/Wii Linux kernel branch.  A full copy of this repository can be downloaded by using git to clone the full repository as shown below.
    ...
    git clone https://github.com/DeltaResero/GC-Wii-Linux-Kernel-3.12.y.git
...
**_Compiled Filesystem/Kernel Demos_**  
	Wii IOS/MINI kernels (3.12.?):  Currently extremely busy elsewhere, I'll try to compile & upload these at a future time...  
